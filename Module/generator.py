...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.conv_t_2 = nn.ConvTranspose2d(1024, 512, kernel_size=4, stride=(4, 2), padding=(0, 0), bias=False)
        ...
        self.conv_t_5 = nn.ConvTranspose2d(128, 64, kernel_size=4, stride=(4, 1), padding=(0, 2), bias=False)
